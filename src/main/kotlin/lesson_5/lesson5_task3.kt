...
fun main() {
    ...
    when {
        (userNum1 == winNum1 && userNum2 == winNum2)
                || (userNum1 == winNum2 && userNum2 == winNum1) -> println("Поздравляем! Вы выиграли главный приз!")

        (userNum1 == winNum1) || (userNum1 == winNum2) || (userNum2 == winNum1)
